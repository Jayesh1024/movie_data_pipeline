...
def main():
    ...
    # Step 1
    date='2024-10-15'
    collection_json_path=extract.page_extract(date=date) # Returns the path of the json file which have the html data for the box office collection page for the run date

    # Step 2
    collection_parsed_path=parse.fact_parser(collection_json_path) # Returns the path of the parsed box office collection page for the run date
    ...
    # Step 4
    movies_parsed_json_path=parse.movie_parser(movies_html_page_json_path) # Returns the path of the json file which have parsed movie page for every movie on the collections page for the input run date
    ...
    # Step 7 (Parallel)
    distributor_html_json_fp=extract.distributor_scraper(movies_parsed_json_path)
